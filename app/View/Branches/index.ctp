<div class="branches index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('streetno'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($branch['Branch']['streetno']); ?>&nbsp;</td>
		<td><?php echo h($branch['Branch']['street']); ?>&nbsp;</td>
		<td><?php echo h($branch['Branch']['city']); ?>&nbsp;</td>
		<td class="actions">
