...
<?php echo $this->Form->create('Drive'); ?>
	<fieldset>
		<legend><?php echo __('Edit Drive'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Drive.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Drive.id'))); ?></li>
