<div class="assistants index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('machine_number'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($assistants as $assistant): ?>
	<tr>
		<td><?php echo h($assistant['Assistant']['id']); ?>&nbsp;</td>
		<td><?php echo h($assistant['Assistant']['machine_number']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $assistant['Assistant']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $assistant['Assistant']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $assistant['Assistant']['id']), null, __('Are you sure you want to delete # %s?', $assistant['Assistant']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
