...
<?php echo $this->Form->create('Assistant'); ?>
	<fieldset>
		<legend><?php echo __('Edit Assistant'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Assistant.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Assistant.id'))); ?></li>
