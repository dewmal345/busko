<div class="administrators index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $administrator['Administrator']['id']), null, __('Are you sure you want to delete # %s?', $administrator['Administrator']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
